cd /d "%~dp0"
copy "P:\NVIDIAGPUCT\CUDA\v12.4\bin\cudart64_12.dll" .\ /Y
copy "P:\NVIDIAGPUCT\CUDA\v12.4\bin\cublasLt64_12.dll" .\ /Y
copy "P:\NVIDIAGPUCT\CUDA\v12.4\bin\cublas64_12.dll" .\ /Y
