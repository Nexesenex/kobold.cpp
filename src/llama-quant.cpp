    ...
    if (name == tn(LLM_TENSOR_OUTPUT, "weight") || (!qs.has_output && name == tn(LLM_TENSOR_TOKEN_EMBD, "weight"))) {
        if (qs.params->output_tensor_type < GGML_TYPE_COUNT) {
            ...
            if (arch == LLM_ARCH_FALCON || nx % qk_k != 0) {
                ...
                new_type = !qs.has_output ? GGML_TYPE_Q5_0 : GGML_TYPE_Q6_K;
            }
            else if (ftype == LLAMA_FTYPE_MOSTLY_IQ4_XS || ftype == LLAMA_FTYPE_MOSTLY_IQ4_S || ftype == LLAMA_FTYPE_MOSTLY_IQ4_M) {
                new_type = !qs.has_output ? GGML_TYPE_Q5_0 : GGML_TYPE_Q6_K;
            }
        ...
        if (qs.params->token_embedding_type < GGML_TYPE_COUNT) {
            ...
            // }
            if (new_type != GGML_TYPE_Q8_0 || new_type != GGML_TYPE_Q6_K) {
        ...
        if (name.find("attn_v.weight") != std::string::npos) {
            if (qs.model.hparams.n_gqa() >= 4 || qs.model.hparams.n_expert >= 4) new_type = GGML_TYPE_Q5_K;
            // else new_type = ftype == LLAMA_FTYPE_MOSTLY_IQ2_S || ftype == LLAMA_FTYPE_MOSTLY_IQ2_M ? GGML_TYPE_IQ3_S : GGML_TYPE_Q2_K;
            else if (ftype == LLAMA_FTYPE_MOSTLY_IQ1_S || ftype == LLAMA_FTYPE_MOSTLY_IQ1_M) new_type = GGML_TYPE_IQ3_XXS;
            else if (ftype == LLAMA_FTYPE_MOSTLY_IQ2_XXS || ftype == LLAMA_FTYPE_MOSTLY_IQ2_XS) new_type = GGML_TYPE_IQ3_S;
            else if (ftype == LLAMA_FTYPE_MOSTLY_IQ2_S || ftype == LLAMA_FTYPE_MOSTLY_IQ2_M) new_type = GGML_TYPE_IQ4_XS;
            ++qs.i_attention_wv;
        }
        ...
        // }
            ...
            if (qs.model.hparams.n_gqa() >= 2 || qs.model.hparams.n_expert >= 4) new_type = GGML_TYPE_Q4_K;	
            else if (ftype == LLAMA_FTYPE_MOSTLY_IQ1_S || ftype == LLAMA_FTYPE_MOSTLY_IQ1_M) new_type = GGML_TYPE_IQ2_XXS;
        ...
        if      (ftype == LLAMA_FTYPE_MOSTLY_Q2_K) {
            new_type = qs.model.hparams.n_gqa() >= 2 ? GGML_TYPE_Q4_K : GGML_TYPE_Q3_K;
        }
        else if (ftype == LLAMA_FTYPE_MOSTLY_Q2_K_S && qs.model.hparams.n_gqa() >= 2) {
            new_type = GGML_TYPE_Q4_K;
        }
        else if (ftype == LLAMA_FTYPE_MOSTLY_IQ3_XXS) {
        ...
        else if ((ftype == LLAMA_FTYPE_MOSTLY_IQ3_M) && qs.model.hparams.n_gqa() >= 2) {
            new_type = GGML_TYPE_Q5_K;
        }
        ...
        // }
            ...
            new_type = qs.model.hparams.n_gqa() >= 4 ? GGML_TYPE_Q6_K : !qs.has_imatrix ? GGML_TYPE_Q6_K : GGML_TYPE_Q5_K;
        }
        else if ((ftype == LLAMA_FTYPE_MOSTLY_IQ4_S || ftype == LLAMA_FTYPE_MOSTLY_IQ4_M) && qs.model.hparams.n_gqa() >= 2) {
            new_type = GGML_TYPE_Q6_K;
        }
        ...
        if (qs.model.hparams.n_expert >= 4) {
            ...
            new_type = GGML_TYPE_Q5_K;
        else if ((ftype == LLAMA_FTYPE_MOSTLY_IQ4_S || ftype == LLAMA_FTYPE_MOSTLY_IQ4_M)
            && qs.model.hparams.n_gqa() >= 2)
            new_type = GGML_TYPE_Q5_K;
        ...
        else if (ftype == LLAMA_FTYPE_MOSTLY_IQ4_M) {
            // new_type = arch == LLM_ARCH_FALCON ? GGML_TYPE_Q4_K : GGML_TYPE_Q5_K;
            new_type = GGML_TYPE_Q5_K;
        }
        ...
        if (arch != LLM_ARCH_FALCON) {
            ...
            else if (ftype == LLAMA_FTYPE_MOSTLY_IQ4_M) new_type = GGML_TYPE_Q5_K;
            else if (ftype == LLAMA_FTYPE_MOSTLY_Q4_K_M) new_type = GGML_TYPE_Q5_K;
            else if (ftype == LLAMA_FTYPE_MOSTLY_Q5_K_M) new_type = GGML_TYPE_Q6_K;
        }
    }
...
static void llama_model_quantize_impl(const std::string & fname_inp, const std::string & fname_out, const llama_model_quantize_params * params) {
    ...
    switch (params->ftype) {
        ...
        case LLAMA_FTYPE_MOSTLY_IQ4_M:
        case LLAMA_FTYPE_MOSTLY_IQ4_S:
