...
//            llama_ctx_params.yarn_orig_ctx = yarn_orig_ctx         // YaRN original context length
		...
		(inputs.quant_k==20?GGML_TYPE_Q4_0:
		(inputs.quant_k==19?GGML_TYPE_Q4_1:
		(inputs.quant_k==18?GGML_TYPE_Q4_1:
		...
		(inputs.quant_k==2?GGML_TYPE_F16:
		(inputs.quant_k==1?GGML_TYPE_F16:
		GGML_TYPE_F16))))))))))))))))))))))))));
		...
		(inputs.quant_v==18?GGML_TYPE_Q4_1:
		(inputs.quant_v==17?GGML_TYPE_Q4_0:
		(inputs.quant_v==16?GGML_TYPE_Q4_1:
		(inputs.quant_v==15?GGML_TYPE_Q5_0:
		(inputs.quant_v==14?GGML_TYPE_Q4_0:
		(inputs.quant_v==13?GGML_TYPE_Q4_1:
		(inputs.quant_v==12?GGML_TYPE_Q5_0:
		(inputs.quant_v==11?GGML_TYPE_Q5_1:
		(inputs.quant_v==10?GGML_TYPE_Q4_0:
		(inputs.quant_v==9?GGML_TYPE_Q4_1:
		(inputs.quant_v==8?GGML_TYPE_Q5_0:
		(inputs.quant_v==7?GGML_TYPE_Q5_1:
		(inputs.quant_v==6?GGML_TYPE_Q8_0:
		(inputs.quant_v==5?GGML_TYPE_Q4_0:
		(inputs.quant_v==4?GGML_TYPE_Q4_1:
		(inputs.quant_v==3?GGML_TYPE_Q5_0:
		(inputs.quant_v==2?GGML_TYPE_Q5_1:
