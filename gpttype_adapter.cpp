...
//    kcpp_params->cache_type_v = inputs.cache_type_v;
    ...
    else if(file_format==FileFormat::GGUF_GENERIC)
    {
        ...
        llama_ctx_params.type_k = (inputs.quant_k==4040?GGML_TYPE_Q4_0:(inputs.quant_k==4140?GGML_TYPE_Q4_1:(inputs.quant_k==5040?GGML_TYPE_Q5_0:(inputs.quant_k==5140?GGML_TYPE_Q5_1:(inputs.quant_k==5141?GGML_TYPE_Q5_1:(inputs.quant_k==5150?GGML_TYPE_Q5_1:(inputs.quant_k==5151?GGML_TYPE_Q5_1:(inputs.quant_k==8040?GGML_TYPE_Q8_0:(inputs.quant_k==8041?GGML_TYPE_Q8_0:(inputs.quant_k==8050?GGML_TYPE_Q8_0:(inputs.quant_k==8051?GGML_TYPE_Q8_0:(inputs.quant_k==8080?GGML_TYPE_Q8_0:GGML_TYPE_F16))))))))))));
        llama_ctx_params.type_v = (inputs.quant_k==4040?GGML_TYPE_Q4_0:(inputs.quant_k==4140?GGML_TYPE_Q4_0:(inputs.quant_k==5040?GGML_TYPE_Q4_0:(inputs.quant_k==5140?GGML_TYPE_Q4_0:(inputs.quant_k==5141?GGML_TYPE_Q4_1:(inputs.quant_k==5150?GGML_TYPE_Q5_0:(inputs.quant_k==5151?GGML_TYPE_Q5_1:(inputs.quant_k==8040?GGML_TYPE_Q4_0:(inputs.quant_k==8041?GGML_TYPE_Q4_1:(inputs.quant_v==8050?GGML_TYPE_Q5_0:(inputs.quant_v==8051?GGML_TYPE_Q5_1:(inputs.quant_v==8080?GGML_TYPE_Q8_0:GGML_TYPE_F16))))))))))));
