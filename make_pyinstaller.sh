...
. create_ver_file.sh
pyinstaller --noconfirm --onefile --clean --console --collect-all customtkinter --collect-all psutil --collect-all pdfplumber --collect-all multiprocess --icon "./niko.ico" \
