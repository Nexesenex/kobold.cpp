cd /d "%~dp0"
copy "P:\NVIDIAGPUCT\CUDA\v12.3\bin\cudart64_12.dll" .\ /Y
copy "P:\NVIDIAGPUCT\CUDA\v12.3\bin\cublasLt64_12.dll" .\ /Y
copy "P:\NVIDIAGPUCT\CUDA\v12.3\bin\cublas64_12.dll" .\ /Y
