...
class model_backend(InferenceModel):
    ...
    def _load(self, save_model: bool, initial_load: bool) -> None:
        ...
        ropeconfig=[self.kcpp_ropescale, self.kcpp_ropebase], stream=False, smartcontext=self.kcpp_smartcontext,
        unbantokens=False, bantokens=None, forceversion=0, nommap=self.kcpp_nommap,
        usemlock=False, noavx2=self.kcpp_noavx2, debugmode=self.kcpp_debugmode, skiplauncher=True, noblas=self.kcpp_noblas,
