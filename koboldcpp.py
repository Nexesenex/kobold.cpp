...
defaultport = 5001
KcppVersion = "1.68Zf"
LcppVersion = "b3235+36"
CudaSpecifics = "Cu12.2_SMC2_Ar60617075_DmmvX32Y2_MMY2_KQIt2"
...
#    makelabelentry(quick_tab, "V Cache config", cache_type_v_var, 1, 200, "Override the default f16 Value cache with quantized cache like q8_0, q5_1, q5_0, q4_1, or q4_0.")
    ...
    # blas batch size
    makeslider(quick_tab, "BLAS Batch Size - optimum of 256 if not filled :", blasbatchsize_text, blas_size_var, 0, 13, 16, width=200, set=9,tooltip="How many tokens to process at once per batch.\nLarger values use more memory.")
