...
#    makelabelentry(quick_tab, "V Cache config", cache_type_v_var, 1, 200, "Override the default f16 Value cache with quantized cache like q8_0, q5_1, q5_0, q4_1, or q4_0.")
    ...
    quick_boxes = {
        ...
        "Use SmartContext": [smartcontext, "Use SmartContext":"Use Smart Context. Now considered outdated and not recommended, except for KVQ with FA.\nCheck the wiki for more info."],
        ...
        "High Priority - disabled by default": [highpriority}, "High Priority - disabled by default": "Increases the koboldcpp process priority.\nMay cause lag or slowdown instead. Not recommended."]
    }
