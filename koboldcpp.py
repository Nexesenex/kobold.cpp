...
def show_new_gui():
    ...
    # context size
    makeslider(quick_tab, "Context Size (supported: 256,512,1024,2048,3072,4096,6144,8192,12288,16384,24576,32768,65536):", contextsize_text, context_var, 0, len(contextsize_text)-1, 30, set=15)
    ...
    # context size
    makeslider(tokens_tab, "Context Size (supported: 256,512,1024,2048,3072,4096,6144,8192,12288,16384,24576,32768,65536):",contextsize_text, context_var, 0, len(contextsize_text)-1, 20, set=15)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--blasbatchsize", help="Sets the batch size used in BLAS processing (default 512). Setting it to -1 disables BLAS mode, but keeps other benefits like GPU offload.", type=int, default=128)
