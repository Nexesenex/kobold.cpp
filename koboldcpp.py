...
#    "Use direct_io": "Enables Direct_IO, accelerating the model loading time.",
    ...
    # blas batch size
    makeslider(hardware_tab, "BLAS Batch Size:", blasbatchsize_text, blas_size_var, 0, 13, 16, set=9,tooltip="How many tokens to process at once per batch.\nLarger values use more memory.")
    # force version
    ...
    qkvslider,qkvlabel,qkvtitle = makeslider(tokens_tab, "Quantize KV Cache:", quantkv_text, quantkv_var, 0, 20, 30, set=0,tooltip="Enable quantization of KV cache.\nRequires FlashAttention and disables ContextShift.")
