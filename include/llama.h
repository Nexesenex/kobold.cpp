...
extern "C" {
    ...
    enum llama_ftype {
        ...
        LLAMA_FTYPE_MOSTLY_IQ3_KS        = 197, // except 1d tensors
                                                //
        ...
        LLAMA_FTYPE_MOSTLY_IQ2_KT        = 949, // except 1d tensors
        LLAMA_FTYPE_MOSTLY_IQ3_KT        = 950, // except 1d tensors
        LLAMA_FTYPE_MOSTLY_IQ4_KT        = 951, // except 1d tensors
